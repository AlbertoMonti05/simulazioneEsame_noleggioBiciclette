...
CREATE TABLE `clienti` (
  ...
  `codiceTessera` int(11) NOT NULL,
  `tesseraSmarrita` BOOLEAN DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;

INSERT INTO `clienti` (`cliente_id`, `nome`, `cognome`, `username`, `mail`, `password`, `indirizzo`, `latitudine`, `longitudine`, `nomeTitolareCarta`, `cognomeTitolareCarta`, `numeroCarta`, `scadenzaCarta`, `cvvCarta`, `codiceTessera`, `tesseraSmarrita`) VALUES
(1, 'Mario', 'Rossi', 'mr', 'mr@gmail.com', 'd9394066970e44ae252fd0347e58c03e', 'via copernico 12, milano', 45.48802624809481, 9.201444324822106, 'Mario', 'Rossi', '1234567890123456', '2028-06', '123', 1000, 1),
(2, 'Paolo', 'Bianchi', 'pbianchi', 'pbianchi@email.com', '202cb962ac59075b964b07152d234b70', 'Via Roma 1', 45.47, 9.18, 'Paolo', 'Bianchi', '1111222233334444', '2026-12', '111', 1001, 0),
(3, 'Laura', 'Verdi', 'lverdi', 'lverdi@email.com', 'e10adc3949ba59abbe56e057f20f883e', 'Via Milano 2', 45.46, 9.19, 'Laura', 'Verdi', '2222333344445555', '2027-05', '222', 1002, 0),
(4, 'Marco', 'Russo', 'mrusso', 'mrusso@email.com', 'f899139df5e1059396431415e770c6dd', 'Via Torino 3', 45.48, 9.2, 'Marco', 'Russo', '3333444455556666', '2025-08', '333', 1003, 0),
(5, 'Giulia', 'Rossi', 'grossi', 'grossi@email.com', '6367c48dd193d56ea7b0baad25b19455', 'Via Napoli 4', 45.45, 9.21, 'Giulia', 'Rossi', '4444555566667777', '2026-11', '444', 1004, 1),
(6, 'Davide', 'Galli', 'dgalli', 'dgalli@email.com', 'edf2fc857e218c6f3d9bc057edebf3f2', 'Via Venezia 5', 45.46, 9.17, 'Davide', 'Galli', '5555666677778888', '2027-09', '555', 1005, 1),
(7, 'Elena', 'Leoni', 'eleoni', 'eleoni@email.com', '7b774effe4a349c6dd82ad4f4f21d34c', 'Via Firenze 6', 45.45, 9.22, 'Elena', 'Leoni', '6666777788889999', '2025-10', '666', 1006, 0),
(8, 'Luca', 'Ferrari', 'lferrari', 'lferrari@email.com', '13f914cb66c62b29d31b6ad2679b3909', 'Via Bologna 7', 45.48, 9.19, 'Luca', 'Ferrari', '7777888899990000', '2027-03', '777', 1007, 0),
(9, 'Sara', 'Brambilla', 'sbrambilla', 'sbrambilla@email.com', 'ac3478d69a3c81fa62e60f5c3696165a', 'Via Genova 8', 45.47, 9.21, 'Sara', 'Brambilla', '8888999900001111', '2026-06', '888', 1008, 1),
(10, 'Matteo', 'Romano', 'mromano', 'mromano@email.com', '81dc9bdb52d04dc20036dbd8313ed055', 'Via Palermo 9', 45.46, 9.23, 'Matteo', 'Romano', '9999000011112222', '2025-12', '999', 1009, 1),
(11, 'Alessia', 'Martini', 'amartini', 'amartini@email.com', 'a04c6f150d2c14b792d0e93d9ab8f22b', 'Via Pisa 10', 45.45, 9.2, 'Alessia', 'Martini', '0000111122223333', '2027-07', '000', 1010, 0),
(12, 'Lorenzo', 'Conti', 'lconti', 'lconti@email.com', 'd251e41299a5ff970fd69ee2f068d7e7', 'Via Torino 11', 45.47, 9.17, 'Lorenzo', 'Conti', '1011121314151617', '2026-04', '101', 1011, 1),
(13, 'Chiara', 'Barbieri', 'cbarbieri', 'cbarbieri@email.com', '25d55ad283aa400af464c76d713c07ad', 'Via Venezia 12', 45.46, 9.18, 'Chiara', 'Barbieri', '1213141516171819', '2025-11', '121', 1012, 1),
(14, 'Giovanni', 'Caruso', 'gcaruso', 'gcaruso@email.com', 'c4ca4238a0b923820dcc509a6f75849b', 'Via Firenze 13', 45.48, 9.22, 'Giovanni', 'Caruso', '1415161718192021', '2026-03', '141', 1013, 0),
(15, 'Martina', 'Santoro', 'msantoro', 'msantoro@email.com', 'c81e728d9d4c2f636f067f89cc14862c', 'Via Bologna 14', 45.45, 9.21, 'Martina', 'Santoro', '1516171819202122', '2027-02', '151', 1014, 1),
(16, 'Andrea', 'Gatti', 'agatti', 'agatti@email.com', 'eccbc87e4b5ce2fe28308fd9f2a7baf3', 'Via Genova 15', 45.46, 9.19, 'Andrea', 'Gatti', '1617181920212223', '2026-05', '161', 1015, 1),
(17, 'Federico', 'Rossi', 'federossi', 'federossi@email.com', 'e99a18c428cb38d5f260853678922e03', 'Via Milano 21', 45.47, 9.18, 'Federico', 'Rossi', '1234567890123456', '2026-12', '456', 1016, 0),
(18, 'Maria', 'Martini', 'mariamart', 'mariamart@email.com', '6c8349cc7260ae62e3b1396831a8398f', 'Via Roma 22', 45.46, 9.19, 'Maria', 'Martini', '2345678901234567', '2027-05', '567', 1017, 1),
(19, 'Giacomo', 'Conte', 'gconte', 'gconte@email.com', '8b1a9953c4611296a827abf8c47804d7', 'Via Torino 23', 45.48, 9.2, 'Giacomo', 'Conte', '3456789012345678', '2025-08', '678', 1018, 1),
(20, 'Silvia', 'Ricci', 'silviaricci', 'silviaricci@email.com', '3c363836cf4e16666669a25da280a186', 'Via Napoli 24', 45.45, 9.21, 'Silvia', 'Ricci', '4567890123456789', '2026-11', '789', 1019, 0),
(21, 'Antonio', 'Ferrari', 'antoniof', 'antoniof@email.com', '34173cb38f07f89ddbebc2ac9128303f', 'Via Venezia 25', 45.46, 9.17, 'Antonio', 'Ferrari', '5678901234567890', '2027-09', '890', 1020, 1),
(22, 'Elena', 'Galli', 'elenagalli', 'elenagalli@email.com', '04d1eaa01a5ec95a80b1b739ce22d288', 'Via Firenze 26', 45.45, 9.22, 'Elena', 'Galli', '6789012345678901', '2025-10', '901', 1021, 0),
(23, 'Roberto', 'Lombardi', 'roblomb', 'roblomb@email.com', '1f0e3dad99908345f7439f8ffabdffc4', 'Via Bologna 27', 45.48, 9.19, 'Roberto', 'Lombardi', '7890123456789012', '2027-03', '012', 1022, 0),
(24, 'Anna', 'Russo', 'annarusso', 'annarusso@email.com', 'c51ce410c124a10e0db5e4b97fc2af39', 'Via Genova 28', 45.47, 9.21, 'Anna', 'Russo', '8901234567890123', '2026-06', '123', 1023, 0),
(25, 'Fabio', 'Leoni', 'fabioleoni', 'fabioleoni@email.com', '70efdf2ec9b086079795c442636b55fb', 'Via Palermo 29', 45.46, 9.23, 'Fabio', 'Leoni', '9012345678901234', '2025-12', '234', 1024, 0),
(26, 'Giorgia', 'Marini', 'giorgiamarini', 'giorgiamarini@email.com', '6f4922f45568161a8cdf4ad2299f6d23', 'Via Pisa 30', 45.45, 9.2, 'Giorgia', 'Marini', '0123456789012345', '2027-07', '345', 1025, 0),
(27, 'Paolo', 'Bianchi', 'paolobianchi', 'paolobianchi@email.com', 'ee11cbb19052e40b07aac0ca060c23ee', 'Via Verdi 31', 45.47, 9.19, 'Paolo', 'Bianchi', '3456789012345678', '2027-10', '456', 1026, 0),
(28, 'Laura', 'Neri', 'lauraneri', 'lauraneri@email.com', '7c4a8d09ca3762af61e59520943dc264', 'Via Dante 32', 45.46, 9.18, 'Laura', 'Neri', '4567890123456789', '2026-11', '567', 1027, 0),
(29, 'Luca', 'Gatti', 'lucagatti', 'lucagatti@email.com', 'b7e14c88b3cfde1529c38694e33cd7a4', 'Via Garibaldi 33', 45.45, 9.17, 'Luca', 'Gatti', '5678901234567890', '2027-09', '678', 1028, 0),
(30, 'Sara', 'Villa', 'saravilla', 'saravilla@email.com', 'ba5eceda1bb0a2f483d8e98c9a4780be', 'Via Roma 34', 45.44, 9.16, 'Sara', 'Villa', '6789012345678901', '2025-10', '789', 1029, 0),
(31, 'Davide', 'Ferrari', 'davideferrari', 'davideferrari@email.com', 'b2f5ff47436671b6e533d8dc3614845d', 'Via Milano 35', 45.48, 9.2, 'Davide', 'Ferrari', '7890123456789012', '2027-03', '890', 1030, 0),
(32, 'Elena', 'Ricci', 'elenaricci', 'elenaricci@email.com', 'c7e1249ffc03eb9ded908c236bd1996d', 'Via Torino 36', 45.47, 9.21, 'Elena', 'Ricci', '8901234567890123', '2026-06', '901', 1031, 0),
(33, 'Marco', 'Leoni', 'marcoleoni', 'marcoleoni@email.com', '6364d3f0f495b6ab9dcf8d3b5c6e0b01', 'Via Firenze 37', 45.46, 9.22, 'Marco', 'Leoni', '9012345678901234', '2025-12', '012', 1032, 0),
(34, 'Giulia', 'Marini', 'giuliamarini', 'giuliamarini@email.com', 'e369853df766fa44e1ed0ff613f563bd', 'Via Napoli 38', 45.45, 9.23, 'Giulia', 'Marini', '0123456789012345', '2027-07', '123', 1033, 0),
(35, 'Andrea', 'Moretti', 'andreamoretti', 'andreamoretti@email.com', 'c81e728d9d4c2f636f067f89cc14862c', 'Via Venezia 39', 45.44, 9.22, 'Andrea', 'Moretti', '1234567890123456', '2026-08', '234', 1034, 0),
(36, 'Simona', 'Gallo', 'simonagallo', 'simonagallo@email.com', 'a87ff679a2f3e71d9181a67b7542122c', 'Via Genova 40', 45.43, 9.21, 'Simona', 'Gallo', '2345678901234567', '2025-04', '345', 1035, 0);
